<script setup>
import statusIcon from '~~/constants/interface-props/statusIcon'
defineProps(statusIcon)
</script>

<template>
  <div v-if="error" class="screenAlert-icon screenAlert-error animate">
  ...
  <div v-if="warning" class="screenAlert-icon screenAlert-warning scaleWarning">
    <span class="screenAlert-body pulseWarningIns"></span>
    <span class="screenAlert-dot pulseWarningIns"></span>
  </div>

  <div v-if="info" class="screenAlert-icon screenAlert-info scaleInfo">
    <span class="screenAlert-dot pulseInfoIns"></span>
    <span class="screenAlert-body pulseInfoIns"></span>
  </div>

  <div v-if="success" class="screenAlert-icon screenAlert-success animate">
