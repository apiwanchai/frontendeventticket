...
/* build-hook-start *//*00001*/try { require('C:\\Users\\newwi\\.vscode\\extensions\\wallabyjs.console-ninja-0.0.92\\out\\buildHook\\index.js').default({tool: 'nuxt'}); } catch(e) { try { import('file:///C:/Users/newwi/.vscode/extensions/wallabyjs.console-ninja-0.0.92/out/buildHook/index.js').then(m => m.default.default({tool: 'nuxt'})).catch(p => {}) } catch(e) { }}/* build-hook-end */
...
import { a as showVersions, s as showBanner } from '../shared/nuxi.1b1e0b8b.mjs';
